...
const salesSchemas = {
  sale: z.object({
    ...
    // Phase 4 / C5+C6: fields consumed by the POST handler + ledger posting.
    // All optional — validated when present, never required.
    ...
    profitMarginTotal: z.number().optional(),
    roundingTotal: z.number().optional(),
    ...
    marketAccountId: z.string().optional(),
    status: z.string().optional(),
    customerName: z.string().optional(),
    subAccountName: z.string().optional(),
    source: z.string().optional().nullable(),
    payments: z.array(z.any()).optional(),
    adjustmentSnapshots: z.array(z.any()).optional(),
