...
export const ACCOUNT_IDS = {
  // Legacy 4-digit codes (used in existing transactions)
  CASH_DRAWER: '1000',
  BANK: '1050',
  MOBILE_MONEY: '1060',
  RECEIVABLE: '1100',
  ...
  SALES: '4000',
  COGS: '5000',
  // New 5-digit account numbers (standard chart)
  CASH_IN_HAND: '11101',
  MAIN_CASH: '11101',
  PETTY_CASH: '11102',
...
export const DEFAULT_ACCOUNTS: Account[] = [
  // --- Assets (10000-19999) ---
  // Note: Both account_type (new) and type (legacy) are provided for backward compatibility
  { id: '1000', code: '1000', account_number: '10000', name: 'Assets', account_type: 'ASSET', type: 'Asset', allow_posting: false, is_system_account: true },
  { id: '1100', code: '1100', account_number: '11000', name: 'Current Assets', account_type: 'ASSET', type: 'Asset', account_group: 'CURRENT_ASSET', allow_posting: false },
  { id: '1110', code: '1110', account_number: '11100', name: 'Cash in Hand', account_type: 'ASSET', type: 'Asset', account_group: 'CURRENT_ASSET', allow_posting: false, subtype: 'CASH' },
  { id: '1111', code: '1111', account_number: '11101', name: 'Main Cash', account_type: 'ASSET', type: 'Asset', account_group: 'CURRENT_ASSET', parent_account_id: '1110', subtype: 'CASH', is_system_account: true },
  { id: '1120', code: '1120', account_number: '11200', name: 'Bank Accounts', account_type: 'ASSET', type: 'Asset', account_group: 'CURRENT_ASSET', allow_posting: false, subtype: 'BANK' },
  { id: '1121', code: '1121', account_number: '11201', name: 'FDH Bank', account_type: 'ASSET', type: 'Asset', account_group: 'CURRENT_ASSET', parent_account_id: '1120', subtype: 'BANK' },
  { id: '1122', code: '1122', account_number: '11202', name: 'NBS Bank', account_type: 'ASSET', type: 'Asset', account_group: 'CURRENT_ASSET', parent_account_id: '1120', subtype: 'BANK' },
  { id: '1200', code: '1200', account_number: '12000', name: 'Accounts Receivable', account_type: 'ASSET', type: 'Asset', account_group: 'CURRENT_ASSET', subtype: 'RECEIVABLE', is_system_account: true },
  { id: '1300', code: '1300', account_number: '13000', name: 'Inventory', account_type: 'ASSET', type: 'Asset', account_group: 'CURRENT_ASSET', subtype: 'INVENTORY', is_system_account: true },
  { id: '1500', code: '1500', account_number: '15000', name: 'Fixed Assets', account_type: 'ASSET', type: 'Asset', account_group: 'FIXED_ASSET', allow_posting: false },
  { id: '1510', code: '1510', account_number: '15100', name: 'Motor Vehicles', account_type: 'ASSET', type: 'Asset', account_group: 'FIXED_ASSET', parent_account_id: '1500' },
  { id: '1520', code: '1520', account_number: '15200', name: 'Furniture & Fixtures', account_type: 'ASSET', type: 'Asset', account_group: 'FIXED_ASSET', parent_account_id: '1500' },

  // --- Liabilities (20000-29999) ---
  { id: '2000', code: '2000', account_number: '20000', name: 'Liabilities', account_type: 'LIABILITY', type: 'Liability', allow_posting: false, is_system_account: true },
  { id: '2100', code: '2100', account_number: '21000', name: 'Current Liabilities', account_type: 'LIABILITY', type: 'Liability', account_group: 'CURRENT_LIABILITY', allow_posting: false },
  { id: '2110', code: '2110', account_number: '21100', name: 'Accounts Payable', account_type: 'LIABILITY', type: 'Liability', account_group: 'CURRENT_LIABILITY', subtype: 'PAYABLE', is_system_account: true },
  { id: '2120', code: '2120', account_number: '21200', name: 'Tax Payable', account_type: 'LIABILITY', type: 'Liability', account_group: 'CURRENT_LIABILITY', allow_posting: false, subtype: 'TAX' },
  { id: '2121', code: '2121', account_number: '21201', name: 'VAT Payable', account_type: 'LIABILITY', type: 'Liability', account_group: 'CURRENT_LIABILITY', parent_account_id: '2120', subtype: 'TAX' },
  { id: '2300', code: '2300', account_number: '23000', name: 'Accrued Expenses', account_type: 'LIABILITY', type: 'Liability', account_group: 'CURRENT_LIABILITY' },

  // --- Equity (30000-39999) ---
  { id: '3000', code: '3000', account_number: '30000', name: 'Equity', account_type: 'EQUITY', type: 'Equity', allow_posting: false, is_system_account: true },
  { id: '3100', code: '3100', account_number: '31000', name: "Owner's Capital", account_type: 'EQUITY', type: 'Equity', account_group: 'EQUITY' },
  { id: '3200', code: '3200', account_number: '32000', name: 'Retained Earnings', account_type: 'EQUITY', type: 'Equity', account_group: 'EQUITY', is_system_account: true },
  { id: '3300', code: '3300', account_number: '33000', name: 'Current Year Earnings', account_type: 'EQUITY', type: 'Equity', account_group: 'EQUITY', is_system_account: true },

  // --- Income (40000-49999) ---
  { id: '4000', code: '4000', account_number: '40000', name: 'Income', account_type: 'INCOME', type: 'Revenue', allow_posting: false, is_system_account: true },
  { id: '4100', code: '4100', account_number: '41000', name: 'Sales / Revenue', account_type: 'INCOME', type: 'Revenue', account_group: 'REVENUE', allow_posting: false },
  { id: '4110', code: '4110', account_number: '41100', name: 'Product Sales', account_type: 'INCOME', type: 'Revenue', account_group: 'REVENUE', is_system_account: true },
  { id: '4200', code: '4200', account_number: '42000', name: 'Other Income', account_type: 'INCOME', type: 'Revenue', account_group: 'OTHER_INCOME', allow_posting: false },

  // --- Expenses (50000-59999) ---
  { id: '5000', code: '5000', account_number: '50000', name: 'Expenses', account_type: 'EXPENSE', type: 'Expense', allow_posting: false, is_system_account: true },
  { id: '5100', code: '5100', account_number: '51000', name: 'Cost of Sales', account_type: 'EXPENSE', type: 'Expense', account_group: 'COST_OF_SALES', allow_posting: false },
  { id: '5120', code: '5120', account_number: '51200', name: 'Cost of Goods Sold', account_type: 'EXPENSE', type: 'Expense', account_group: 'COST_OF_SALES', is_system_account: true },
  { id: '5200', code: '5200', account_number: '52000', name: 'Operating Expenses', account_type: 'EXPENSE', type: 'Expense', account_group: 'OPERATING_EXPENSE', allow_posting: false },
  { id: '5210', code: '5210', account_number: '52100', name: 'Salaries & Wages', account_type: 'EXPENSE', type: 'Expense', account_group: 'OPERATING_EXPENSE', parent_account_id: '5200' },
  { id: '5220', code: '5220', account_number: '52200', name: 'Rent', account_type: 'EXPENSE', type: 'Expense', account_group: 'OPERATING_EXPENSE', parent_account_id: '5200' },
  { id: '5230', code: '5230', account_number: '52300', name: 'Utilities', account_type: 'EXPENSE', type: 'Expense', account_group: 'OPERATING_EXPENSE', parent_account_id: '5200' },
  { id: '5290', code: '5290', account_number: '52900', name: 'Bank Charges', account_type: 'EXPENSE', type: 'Expense', account_group: 'OPERATING_EXPENSE', parent_account_id: '5200' },
];
