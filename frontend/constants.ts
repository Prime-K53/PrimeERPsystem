...
export const DEFAULT_ACCOUNTS: Account[] = [
  ...
  { id: '11000', code: '11000', account_number: '11000', name: 'Current Assets', account_type: 'ASSET', type: 'Asset', account_group: 'CURRENT_ASSET', parent_account_id: '10000', allow_posting: false },
  { id: '11100', code: '11100', account_number: '11100', name: 'Cash in Hand', account_type: 'ASSET', type: 'Asset', account_group: 'CURRENT_ASSET', parent_account_id: '11000', allow_posting: false, subtype: 'CASH' },
  ...
  { id: '11200', code: '11200', account_number: '11200', name: 'Bank Accounts', account_type: 'ASSET', type: 'Asset', account_group: 'CURRENT_ASSET', parent_account_id: '11000', allow_posting: false, subtype: 'BANK' },
  ...
  { id: '11300', code: '11300', account_number: '11300', name: 'Accounts Receivable', account_type: 'ASSET', type: 'Asset', account_group: 'CURRENT_ASSET', parent_account_id: '11000', subtype: 'RECEIVABLE', is_system_account: true },
  ...
  { id: '11400', code: '11400', account_number: '11400', name: 'Inventory', account_type: 'ASSET', type: 'Asset', account_group: 'CURRENT_ASSET', parent_account_id: '11000', subtype: 'INVENTORY', is_system_account: true },
  ...
  { id: '11500', code: '11500', account_number: '11500', name: 'Other Current Assets', account_type: 'ASSET', type: 'Asset', account_group: 'CURRENT_ASSET', parent_account_id: '11000', allow_posting: false },
  ...
  { id: '12000', code: '12000', account_number: '12000', name: 'Fixed Assets', account_type: 'ASSET', type: 'Asset', account_group: 'FIXED_ASSET', parent_account_id: '10000', allow_posting: false },
  ...
  { id: '21100', code: '21100', account_number: '21100', name: 'Accounts Payable', account_type: 'LIABILITY', type: 'Liability', account_group: 'CURRENT_LIABILITY', parent_account_id: '21000', subtype: 'PAYABLE', is_system_account: true },
  ...
  { id: '21200', code: '21200', account_number: '21200', name: 'Tax Payable', account_type: 'LIABILITY', type: 'Liability', account_group: 'CURRENT_LIABILITY', parent_account_id: '21000', allow_posting: false, subtype: 'TAX' },
  ...
  { id: '21300', code: '21300', account_number: '21300', name: 'Accrued Expenses', account_type: 'LIABILITY', type: 'Liability', account_group: 'CURRENT_LIABILITY', parent_account_id: '21000', allow_posting: true },
  { id: '22000', code: '22000', account_number: '22000', name: 'Long-Term Liabilities', account_type: 'LIABILITY', type: 'Liability', account_group: 'LONG_TERM_LIABILITY', parent_account_id: '20000', allow_posting: false },
  ...
  { id: '22400', code: '22400', account_number: '22400', name: 'Current Portion of Long-Term Debt', account_type: 'LIABILITY', type: 'Liability', account_group: 'CURRENT_LIABILITY', parent_account_id: '21000', allow_posting: true },
  // --- Equity (30000-39999) ---
  ...
  { id: '41000', code: '41000', account_number: '41000', name: 'Sales / Revenue', account_type: 'INCOME', type: 'Revenue', account_group: 'REVENUE', parent_account_id: '40000', allow_posting: false },
  { id: '41100', code: '41100', account_number: '41100', name: 'Product Sales', account_type: 'INCOME', type: 'Revenue', account_group: 'REVENUE', parent_account_id: '41000', is_system_account: true },
  { id: '41200', code: '41200', account_number: '41200', name: 'Service Income', account_type: 'INCOME', type: 'Revenue', account_group: 'REVENUE', parent_account_id: '41000', is_system_account: true },
  { id: '42000', code: '42000', account_number: '42000', name: 'Other Income', account_type: 'INCOME', type: 'Revenue', account_group: 'OTHER_INCOME', parent_account_id: '40000', allow_posting: false },
  { id: '42100', code: '42100', account_number: '42100', name: 'Interest Income', account_type: 'INCOME', type: 'Revenue', account_group: 'OTHER_INCOME', parent_account_id: '42000', allow_posting: true },
  { id: '42200', code: '42200', account_number: '42200', name: 'Discount Received', account_type: 'INCOME', type: 'Revenue', account_group: 'OTHER_INCOME', parent_account_id: '42000', allow_posting: true },
  ...
  { id: '51000', code: '51000', account_number: '51000', name: 'Cost of Sales', account_type: 'EXPENSE', type: 'Expense', account_group: 'COST_OF_SALES', parent_account_id: '50000', allow_posting: false },
  ...
  { id: '51200', code: '51200', account_number: '51200', name: 'Cost of Goods Sold', account_type: 'EXPENSE', type: 'Expense', account_group: 'COST_OF_SALES', parent_account_id: '51000', is_system_account: true },
  ...
  { id: '52000', code: '52000', account_number: '52000', name: 'Operating Expenses', account_type: 'EXPENSE', type: 'Expense', account_group: 'OPERATING_EXPENSE', parent_account_id: '50000', allow_posting: false },
  ...
  { id: '54000', code: '54000', account_number: '54000', name: 'Other Expenses', account_type: 'EXPENSE', type: 'Expense', account_group: 'OTHER_EXPENSE', parent_account_id: '50000', allow_posting: false },
